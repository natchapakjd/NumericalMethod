...
const Parser = require('expr-eval').Parser;
 ...
 class Onepoint extends React.Component {
    ...
    OnepointCalfunction(X0,ErrorApox,Funct){
        ...
        while(true){
            x1 = fx(x0);
            ErrorApox_Answer = Math.abs((x1-x0)/x1)*100;
    ...
    handleSubmit(event){
        ...
        const xm = this.OnepointCalfunction(X0,ErrorApox,Funct)
    ...
    render(){
        ...
        return (
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <h1>OnepointIterationMethod&emsp;</h1>
                </div>
